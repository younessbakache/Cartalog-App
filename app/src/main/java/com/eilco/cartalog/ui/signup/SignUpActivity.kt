package com.vitor238.cartalog.ui.signup
...
import com.vitor238.cartalog.databinding.ActivitySignUpBinding
import com.vitor238.cartalog.ui.base.BaseActivity
import com.vitor238.cartalog.ui.home.MainActivity
import com.vitor238.cartalog.ui.login.LoginActivity
import com.vitor238.cartalog.ui.viewmodel.AuthViewModel
import com.vitor238.cartalog.ui.viewmodel.AuthViewModelFactory
import com.vitor238.cartalog.ui.viewmodel.ProfileViewModel
import com.vitor238.cartalog.utils.text
            ...
            registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result: ActivityResult ->
                when (result.resultCode) {
                    ...
                    Activity.RESULT_CANCELED -> {
                        ...
                        Log.e(TAG, "Result Canceled. requestCode: resultCode: ${result.resultCode}")
                        result.data?.extras?.let { bundle ->
                            for (key in bundle.keySet()) {
                                Log.d(LoginActivity.TAG, "Key: $key, Value: ${bundle[key]}")
                            }
                        }
                        showSnackBar(binding.root, R.string.failed_to_register)
                    }
